...
Hugo's [`.Parent` shortcode variable][parent] provides access to the parent shortcode context when it is called within the context of a *parent* shortcode. This provides an inheritance model for common shortcode parameters.
